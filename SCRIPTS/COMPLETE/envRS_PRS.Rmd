...
dat_long = merge(scores, bpm)
```

# Cross-sectional models at baseline CBCL

Compare depRS only with adding PRS - does it explain more variance? How do the 3 different PRS compare? It looks like the hierarchical one does best. 
...
## intRS and CBCL internalising

Predicting internalising is (expectedly) somewhat poor
...
anova(mddm0, mddm1, mddm2, mddm3) %>% as.data.frame() %>% 
