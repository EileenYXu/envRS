...
# Combining envRS with PRS for longitudinal outcomes

Model comparisons of envRS and PRS in predicting longitudinal outcomes.
...
At year 3, CBCL data were available for `r nrow(cbcl_y3)` participants. \
`r nrow(s_dat)` participants have year 3 CBCL data, PRS and baseline envRS. \
...
At year 4, CBCL data were available for `r nrow(cbcl_y4)` participants. \
`r nrow(s_dat)` participants have year 3 CBCL data, PRS and baseline envRS. \
Model comparisons are run for: \
m1 = cbcl ~ envRS \
m2 = cbcl ~ envRS + PRS \
