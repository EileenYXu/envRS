...
#saveRDS(envRS, "G://users/eileen/ABCD/ABCD_Environmental_Risk/ABCDv5.1/DATA/envRS_baseline.rds")
...
#write.csv(base_coefs, "G://users/eileen/ABCD/ABCD_Environmental_Risk/ABCDv5.1/OUTPUT/base_coefs.csv")
...
```{r}
train = readRDS("G://users/eileen/ABCD/ABCD_Environmental_Risk/ABCDv5.1/DATA/baseline_traindat.rds") |> na.omit() |> filter(birthsex != "Intersex") |> droplevels()
test = readRDS("G://users/eileen/ABCD/ABCD_Environmental_Risk/ABCDv5.1/DATA/baseline_testdat.rds") |> na.omit() |> filter(birthsex != "Intersex") |> droplevels()
...
intRS = rbind(intRS_train, intRS_test)
envRS = merge(depRS, intRS, by = "src_subject_id")
#saveRDS(envRS,  "G://users/eileen/ABCD/ABCD_Environmental_Risk/ABCDv5.1/DATA/envRS_baseline_sens.rds")
...
```{r fig.width=10, fig.height=10}
base_coefs = rbind(coef_int[-1,], coef_dep[-1,])
#write.csv(base_coefs, "G://users/eileen/ABCD/ABCD_Environmental_Risk/ABCDv5.1/OUTPUT/baseline_coefs_sens.csv")
