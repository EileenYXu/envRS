...
```{r}
y2_coefs_sig |> filter(out=="CBCL_depression") |> arrange(desc(beta.min)) |> kbl() |> kable_styling() |> scroll_box(height = "300px")
```

### CBCL internalising

```{r}
y2_coefs_sig |> filter(out=="CBCL_internalising") |> arrange(desc(beta.min)) |> kbl() |> kable_styling() |> scroll_box(height = "300px")
```


```{r fig.height=10, fig.width=10}
y2_coefs_sig |> arrange(desc(beta.min)) |> kbl() |> kable_styling() |> scroll_box(height = "300px")
