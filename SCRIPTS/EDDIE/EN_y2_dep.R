...
for (i in 1:length(datlist)) {
	...
	y[[i]] = as.numeric(datlist[[i]]$cbcl_dsm5_depress)
}
...
write.csv(y2_coefs, "/home/s1659680/ABCD/output/y2_dep_coefs.csv")

saveRDS(fit, "/home/s1659680/ABCD/output/y2_dep_fit.rds")
