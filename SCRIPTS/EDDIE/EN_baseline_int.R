...
write.csv(base_coefs, "/home/s1659680/ABCD/output/baseline_int_coefs.csv")

saveRDS(fit, "/home/s1659680/ABCD/output/baseline_int_fit.rds")
...
#  preds[[i]] = datlist.train[[i]][,-which(colnames(datlist.train[[i]]) %in% rem_cols)]
...
#  preds[[i]] = datlist.test[[i]][,2:18]
#  outs[[i]] = datlist.test[[i]][,19:20]
#}
...
write.csv(result.stats, "/home/s1659680/ABCD/output/baseline_int_results.csv")