...
y2CBCL = dat |> filter(eventname=="2_year_follow_up_y_arm_1") |> select(src_subject_id, cbcl_scr_dsm5_depress_r, cbcl_scr_syn_internal_r) |> drop_na(cbcl_scr_dsm5_depress_r, cbcl_scr_dsm5_depress_r)
...
#merge in y2 CBCL
dat.mod = merge(baseline, y2CBCL, by = "src_subject_id")
```
...
dat.mod = dat.mod |> select_if(~ sum(is.na(.))<0.2*nrow(dat.mod))

dat.mod = dat.mod |> select(-c(eventname, illicit, site_id_l, rel_family_id, rel_birth_id, interview_date, visit_type, race_ethnicity))
...
N = `r nrow(dat.mod |> filter(gender == "GNC"))` individuals identifying as gender non-conforming were excluded.
...
N = `r nrow(dat)` split into training 80/% (N = `r nrow(train)`) and test 20/% (N = `r nrow(test)`) samples. \
...
saveRDS(depRS, "G://users/eileen/ABCD/ABCD_Environmental_Risk/ABCDv5.1/DATA/depRS_long.rds")
```
...
saveRDS(intRS, "G://users/eileen/ABCD/ABCD_Environmental_Risk/ABCDv5.1/DATA/intRS_long.rds")
```
...
write.csv(base_coefs, "C://Users/eilee/Desktop/PhD/Year 3/Drafts/envRS_paper/long_coefs.csv")
```
...
write.csv(coefs_sig, "C://Users/eilee/Desktop/PhD/Year 3/Drafts/envRS_paper/long_coefs_sig.csv")
```
...
ggsave(filename = "C://Users/eilee/Desktop/PhD/Year 3/Drafts/envRS_paper/long_coefs_sig.svg", height = 200, width = 200, units = "mm")
```
...
ggsave(filename = "C://Users/eilee/Desktop/PhD/Year 3/Drafts/envRS_paper/long_01.svg", height = 140, width = 200, units = "mm")
```
