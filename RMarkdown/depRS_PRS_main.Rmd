...
saveRDS(youth, "C:/Users/eilee/Desktop/PhD/Year 3/envRS/SCRIPTS/main_roc_youth.rds")
```
...
saveRDS(parent, "C:/Users/eilee/Desktop/PhD/Year 3/envRS/SCRIPTS/main_roc_parent.rds")
```
...
```{r}
descriptives = list("youth_all" = all_y_sum,"youth_case" = case_y_sum, "youth_ctrl" = ctrl_y_sum, "parent_all" = all_p_sum, "parent_case" = case_p_sum, "parent_ctrl" = ctrl_p_sum)

openxlsx::write.xlsx(descriptives, "C://Users/eilee/Desktop/PhD/Year 3/Drafts/envRS_paper/MDD_PRS_DESC.xlsx")
```
